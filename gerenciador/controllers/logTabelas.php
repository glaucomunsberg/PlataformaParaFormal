...
class LogTabelas extends Controller {
	...
	function listaTabelas(){
		$this->ajax->returnJqGrid($this->logTabelaModel->getTabelas($_GET));
	}
	...
	function listaColunas($esquema, $tabela){
		$this->ajax->returnJqGrid($this->logTabelaModel->getColunas($_GET, $esquema, $tabela));
	}
	...
	function listaLogTabela($esquema, $tabela){
		$this->ajax->returnJqGrid($this->logTabelaModel->getLogTabela($_GET, $esquema, $tabela));
	}
