...
COPY grupos_atividades (id, cidade_id, geocode_origem_latitude, geocode_origem_longitude, geocode_destino_latitude, geocode_destino_longitude, dt_ocorrencia, dt_cadastro, descricao) FROM stdin;
\.
...
3c150ab91cd1bebc11ab84042ed71014	127.0.0.1	Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.31 (	1365169437	\N
