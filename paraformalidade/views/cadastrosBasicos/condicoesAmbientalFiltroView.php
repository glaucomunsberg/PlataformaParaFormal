<?=$this->load->view("../../static/_views/headerGlobalView");?>
	...
	<?=begin_JqGridPanel('gridCondicaoAmbiental', 'auto', '', base_url().'paraformalidade/cadastrosBasicos/condicoesAmbiental/listaCondicoesAmbientais/', array('sortname'=> 'descricao', 'autowidth'=> true, 'pager'=> true, 'caption'=>lang('condicoesAmbientaisLista')));?>
...
<script>
	...
	function novo(){
		location.href = BASE_URL+'paraformalidade/cadastrosBasicos/condicoesAmbiental/novo/';
	}
 
	
	function gridCondicaoAmbiental_click(id){
		location.href = BASE_URL+'paraformalidade/cadastrosBasicos/condicoesAmbiental/editar/'+id;
	}
	...
	function excluirNotaTipo(confirmaExclusao){
		if(confirmaExclusao){
			...
			$.post(BASE_URL+'paraformalidade/cadastrosBasicos/condicoesAmbiental/excluir/', {id: notaTipos}, 
				function(data){
					if(data.success)
