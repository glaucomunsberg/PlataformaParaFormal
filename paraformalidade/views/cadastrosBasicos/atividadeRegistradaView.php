<?=$this->load->view("../../static/_views/headerGlobalView");?>
	...
	<?=begin_TabPanel('tabAtividadeRegistrada');?>
		<?=begin_Tab(lang('atividadesRegistradasFiltro'));?>
			<?=begin_form('paraformalidade/cadastrosBasicos/atividadeRegistrada/salvar', 'formAtividadeRegistrada');?>
...
<script>
	...
	function listaAtividadesRegistradas(){
		location.href = BASE_URL+'paraformalidade/cadastrosBasicos/atividadeRegistrada/';
	}

	function salvar(){
		formAtividadeRegistrada_submit();
	}
	
	function formAtividadeRegistrada_callback(data){
	...
	function excluirAtividadeRegistrada(confirmaExclusao){
		if(confirmaExclusao){
			$.post(BASE_URL+'paraformalidade/cadastrosBasicos/atividadeRegistrada/excluir/', {id: $('#txtAtividadeRegistradaId').val()}, 
				function(data){
					if(data.success)
