<?=$this->load->view("../../static/_views/headerGlobalView");?>
	...
	<?=begin_TabPanel('tabNotaTipo');?>
		<?=begin_Tab(lang('condicoesAmbientaisFiltro'));?>
			<?=begin_form('paraformalidade/cadastrosBasicos/condicoesAmbiental/salvar', 'formCondicoesAmbiental');?>
...
<script>
	...
	function listaCondicoesAmbientais(){
		location.href = BASE_URL+'paraformalidade/cadastrosBasicos/condicoesAmbiental/';
	}
	...
	function excluirCondicoesAmbiental(confirmaExclusao){
		if(confirmaExclusao){
			$.post(BASE_URL+'paraformalidade/cadastrosBasicos/condicoesAmbiental/excluir/', {id: $('#txtCondicaoAmbientalId').val()}, 
				function(data){
					if(data.success)
