<?= $this->load->view("../../static/_views/headerGlobalView"); ?>
	...
	<?=begin_TabPanel();?>
		<?=begin_Tab(lang('pessoaFiltro'));?>
				...
				<?=new_line();?>
                                ...
                                <?= form_textFieldAutoComplete('txtColaboradorCidadeId', BASE_URL . 'paraformalidade/cadastros/colaboradores/buscarCidade', '', '', 400) ?>
                                <?=new_line();?>
	...
	<?=begin_JqGridPanel('gridColaboradores', 'auto', '', base_url().'paraformalidade/cadastros/colaboradores/listaColaboradores', array('sortname'=> 'nome', 'autowidth'=> true, 'pager'=> false, 'caption'=>lang('colaboradorPessoaGrid')));?>
...
<script type="text/javascript">    
    ...
    function gridColaboradores_click(id){
        location.href = BASE_URL+'paraformalidade/cadastros/colaboradores/editar/'+id;
    }
	...
	if(confirmaExclusao){
		...
		$.post(BASE_URL+'paraformalidade/cadastros/colaboradores/excluir/', {id: colaborador}, 
                    function(data){
                        if(data.success)
