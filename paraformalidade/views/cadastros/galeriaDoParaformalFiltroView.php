<?=$this->load->view("../../static/_views/headerGlobalView");?>
	...
	<?=begin_JqGridPanel('gridGrupoAtividade', 'auto', '', base_url().'paraformalidade/cadastros/galeriaDaParaformalidade/listaGruposAtividades/', array('sortname'=> 'descricao', 'autowidth'=> true, 'pager'=> true, 'caption'=>lang('grupoAtividadeLista')));?>
...
<script>
	...
	function gridGrupoAtividade_click(id){
		location.href = BASE_URL+'paraformalidade/cadastros/galeriaDaParaformalidade/verGaleria/'+id;
	}
