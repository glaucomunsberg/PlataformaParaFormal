<?=$this->load->view("../../static/_views/headerGlobalView");?>
	...
	<?=begin_JqGridPanel('gridGrupoAtividade', 'auto', '', base_url().'paraformalidade/cadastros/grupoAtividade/listaGruposAtividades/', array('sortname'=> 'descricao', 'autowidth'=> true, 'pager'=> true, 'caption'=>lang('grupoAtividadeLista')));?>
		<?=addJqGridColumn('id', 'ID', 0, 'right', array('sortable'=>true, 'hidden'=> true));?>
                <?=addJqGridColumn('nomecidade', lang('grupoAtividadeCidade'), 17, 'center', array('sortable'=>true));?>
...
<script>
	...
	function gridGrupoAtividade_click(id){
		location.href = BASE_URL+'paraformalidade/cadastros/equipeGrupoAtividade/equipe/'+id;
	}		
