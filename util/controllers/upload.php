<?php
	...
	class Upload extends Controller{
			...
			if(! $files = $this->upload->do_upload()){
				...
				for($i=0; $i<$totalArquivos; $i++){
					...
					if(substr($upload->tipo, 0, 5) == 'image'){
						...
						$storedfile = $gridFS->storeFile($pathArchive.'archives/thumbs_48x48/'.$upload->nome_gerado,
												array('filename' => $upload->nome_gerado,
						...
						$storedfile = $gridFS->storeFile($pathArchive.'archives/thumbs_80x80/'.$upload->nome_gerado,
												array('filename' => $upload->nome_gerado,
														'filename_original' => $upload->nome_original,
														'type' => $upload->tipo,
														'thumb' => '80x80'));
						...
						$storedfile = $gridFS->storeFile($pathArchive.'archives/resized_640x480/'.$upload->nome_gerado,
												array('filename' => $upload->nome_gerado,
														'filename_original' => $upload->nome_original,
														'type' => $upload->tipo,
														'thumb' => '640x480'));
				...
				$storedfile = $gridFS->storeFile($pathArchive.'archives/'.$upload->nome_gerado,
												array('filename' => $upload->nome_gerado,
														'filename_original' => $upload->nome_original,
														'type' => $upload->tipo,
														'no_thumb' => true));
		...
		function enviarImagemWebCam(){
			...
			$storedfile = $gridFS->storeFile($pathArchive.'archives/crop_3x4/'.$upload->nome_gerado,
									array('filename' => $upload->nome_gerado,
											'filename_original' => $upload->nome_original,
											'type' => $upload->tipo,
											'thumb' => '3x4'));
			...
			$storedfile = $gridFS->storeFile($pathArchive.'archives/thumbs_256x309/'.$upload->nome_gerado,
									array('filename' => $upload->nome_gerado,
											'filename_original' => $upload->nome_original,
											'type' => $upload->tipo,
											'thumb' => '256x309'));
			...
			$storedfile = $gridFS->storeFile($pathArchive.'archives/thumbs_354x472/'.$upload->nome_gerado,
									array('filename' => $upload->nome_gerado,
											'filename_original' => $upload->nome_original,
											'type' => $upload->tipo,
											'thumb' => '354x472'));
