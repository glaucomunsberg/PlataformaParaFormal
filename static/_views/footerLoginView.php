                <div id="sobre" style="position:absolute; left: 0px; top: 0px; width: 100%; height: auto; margin: 0; page: 0; z-index: 100; background-color:#7A8628; visibility: hidden; opacity: 0.5; filter: alpha(opacity=50); overflow: autor;   ">
                    oiiiieee
                </div>
                <div id="footer" class="ui-state-highlight ui-widget">
			&copy;2012 Plataforma do Paraformal / <a href="#" onclick="oi();">Sobre</a> / <a href="javascript:;">Termos de serviço</a>
		</div>
